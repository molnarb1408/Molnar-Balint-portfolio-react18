...
import { contactInfo, isHireable } from "../portfolio.tsx";
import { Fade } from "react-awesome-reveal";
import { GithubProfileCardProps } from "../types/GithubProfileCard.types.ts";
  ...
  return (
    <Fade direction="up" duration={800} triggerOnce>
      <div className="main" id="contact">
        <h1 className="prof-title">Elérhetőségem</h1>
        <div className="row">
